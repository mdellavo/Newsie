...
public class VerticalViewPager extends ViewPager {
    ...
    private static final String TAG = Log.buildTag(VerticalViewPager.class);
    WebView webview;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (webview != null) {
            ...
            this.requestDisallowInterceptTouchEvent(scrolling);
        }
    ...
    public void attachWebView(final WebView view) {
        webview = view;
    }
}